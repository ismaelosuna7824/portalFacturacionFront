    ...
    // FullComponent.totalC = 0;
      ...
      if(this.fechaIn == "" && this.fechaFin == "" && this.tipoC != ""){
        ...
        this.conteoFactura().then((x:any)=>{
          ...
          this.serviceInicio.facturas(fechaI, fechaF, this.tipoC, limitA, limitB, 0).then((resp:any)=>{
          ...
          this.serviceInicio.reporteTotal(fechaI, fechaF, this.tipoC, 0).then((tot:any)=>{
            this.loading = false;
...
conteoFactura(){ 
      return new Promise<void>((resolve, reject) => {
        ...
        if(this.fechaIn == "" && this.fechaFin == "" && this.tipoC != ""){
          ...
          fechaI = new Date(this.fechaIn).toISOString().slice(0,10);
          fechaF = new Date(this.fechaFin).toISOString().slice(0,10);
          this.serviceInicio.facturasConteo(fechaI, fechaF, this.tipoC, 0).then((resp:any)=>{
